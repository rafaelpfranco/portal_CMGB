<?php
	...
	if(!mail("selecao6@cmgb.com.br", $assunto, $mensagemHTML, $headers ,"-r".$emailsender)){ // Se for Postfix
		$headers .= "Return-Path: " . $emailsender . $quebra_linha; // Se "não for Postfix"
		mail("selecao6@cmgb.com.br", $assunto, $mensagemHTML, $headers );
	...
	header('Location: http://portal.cmgb.com.br/formul%C3%A1rios/form6.html');
	exit;
