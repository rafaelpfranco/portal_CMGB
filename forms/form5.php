<?php
	...
	if(!mail("selecao5@cmgb.com.br", $assunto, $mensagemHTML, $headers ,"-r".$emailsender)){ // Se for Postfix
		$headers .= "Return-Path: " . $emailsender . $quebra_linha; // Se "não for Postfix"
		mail("selecao5@cmgb.com.br", $assunto, $mensagemHTML, $headers );
	...
	header('Location: http://portal.cmgb.com.br/formul%C3%A1rios/form5.html');
	exit;
