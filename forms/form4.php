<?php
	...
	if(!mail("selecao4@cmgb.com.br", $assunto, $mensagemHTML, $headers ,"-r".$emailsender)){ // Se for Postfix
		$headers .= "Return-Path: " . $emailsender . $quebra_linha; // Se "não for Postfix"
		mail("selecao4@cmgb.com.br", $assunto, $mensagemHTML, $headers );
	...
	header('Location: http://portal.cmgb.com.br/formul%C3%A1rios/form4.html');
	exit;
